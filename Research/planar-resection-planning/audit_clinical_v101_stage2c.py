...
CANDIDATES = {
    "trial18": ["2026082201", "2026082202", "2026082203"],
    "trial19": ["2026082204", "2026082205", "2026082206"],
}
...
def main() -> None:
    ...
    parser.add_argument("--stage2c-dir", required=True, type=Path)
    ...
    for cand, seeds in CANDIDATES.items():
        ...
        for seed in seeds:
            run_dir = args.stage2c_dir / cand / f"seed_{seed}"
