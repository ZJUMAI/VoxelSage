...
def run(ctx):
    ...
    return convert_numpy({
        ...
        "total_tumor_volume_cm3": analysis["total_tumor_volume_cm3"],
        "largest_tumor_volume_cm3": analysis["largest_tumor_volume_cm3"],
        "volume_lesion_count": analysis["volume_lesion_count"],
        "volume_scope": analysis["volume_scope"],
