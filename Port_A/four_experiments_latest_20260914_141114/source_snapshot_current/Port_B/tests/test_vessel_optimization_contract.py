"""Compatibility tests for the VoxelSage vessel-optimization audit schema."""
...
class AuditSchemaCompatibilityTests(unittest.TestCase):
    def test_new_schema_is_the_writer_identifier(self):
        self.assertEqual(AUDIT_SCHEMA, "voxelsage.vessel-optimization-audit")
        self.assertTrue(is_supported_audit_schema("geosurge.vessel-optimization-audit"))
