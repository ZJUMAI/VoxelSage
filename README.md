...
on the first inference and then reused from the local cache. TotalSegmentator is another supported segmentation model, which needs additional installation.
